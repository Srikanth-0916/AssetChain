...
const DEFAULT_ACTIVITIES: ActivityFeedItem[] = [
  {
    ...
    type: 'investor',
    actor: 'Accredited Investor INV-9021',
    title: 'New Institutional Capital Investment',
    description: 'Purchased 250 ERC-3643 tokens ($71,375)',
    txHash: '0x8f9d...1f90',
  },
  {
    id: 'act-002',
    ...
    type: 'dividend',
    actor: 'Asset Owner SPV Treasury',
    title: 'Q2 Rental Dividend Disbursed',
    description: '$48,250 rental income deposited to tokenholders',
    txHash: '0x489d...fb10',
  },
  {
    id: 'act-003',
    ...
    type: 'legal',
    actor: 'Senior Title Advocate M. Sharma',
    title: '30-Year Nil-Encumbrance Certified',
    description: 'Title deed clearance issued & posted on-chain',
  },
  {
    id: 'act-004',
    timestamp: 'Yesterday',
    type: 'verification',
    actor: 'Verification Officer R. Mehta',
    title: 'Knight Frank Valuation Report Approved',
    description: '$2,500,000 property appraisal confirmed',
  },
  {
    id: 'act-005',
    timestamp: '2 days ago',
    type: 'governance',
    actor: 'TrustChain DAO Governance',
    title: 'DAO Proposal Opened: Elevate Reserve Fund',
    description: 'Voting opened to all tokenholders until Aug 15',
  },
];
