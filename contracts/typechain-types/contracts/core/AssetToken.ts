...
export namespace TransferRestrictionChangedEvent {
...
export interface AssetToken extends BaseContract {
  ...
  assetId: TypedContractMethod<[], [bigint], "view">;

  assetOwner: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getEvent(
    key: "TransferRestrictionChanged"
  ): TypedContractEvent<
    TransferRestrictionChangedEvent.InputTuple,
    TransferRestrictionChangedEvent.OutputTuple,
    TransferRestrictionChangedEvent.OutputObject
  >;
  getEvent(
    key: "Unpaused"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "TransferRestrictionChanged(bool)": TypedContractEvent<
      TransferRestrictionChangedEvent.InputTuple,
      TransferRestrictionChangedEvent.OutputTuple,
      TransferRestrictionChangedEvent.OutputObject
    >;
    TransferRestrictionChanged: TypedContractEvent<
      TransferRestrictionChangedEvent.InputTuple,
      TransferRestrictionChangedEvent.OutputTuple,
      TransferRestrictionChangedEvent.OutputObject
    >;
